...
# Select the highest resolution sensor mode
highest_res_mode = picam2.sensor_modes[2]  # Mode 3 (4608x2592)

# Create a configuration for capturing still images at maximum resolution
config = picam2.create_still_configuration(
    sensor={
        'output_size': highest_res_mode['size'],  # Set resolution
        'bit_depth': highest_res_mode['bit_depth']  # Set bit depth
    }
)
