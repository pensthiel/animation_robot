...
picam2.set_controls({"ScalerCrop": offset + size,"ExposureTime": exp, "AnalogueGain": gain,"ColourGains":(1.6,2.7),"AfMode": AfModeEnum.Manual, "LensPosition": focus,"ColourTemperature":color_temp})
